...
type LedgerTransaction struct {
	VoucherJournalNo     int     `xml:"VoucherJournalNo"`
	AuditNo              int     `xml:"AuditNo"`
	Year                 int     `xml:"Year"`
	Period               int     `xml:"Period"`
	AccountNo            int     `xml:"AccountNo"`
	OrgUnit1             int     `xml:"OrgUnit1"`
	OrgUnit9             int     `xml:"OrgUnit9"`
	PostedAmountDomestic float32 `xml:"PostedAmountDomestic"`
}
